...
namespace EFHooks.Tests
{
    public partial class HookedDbContextTests
    {
        ...
        private class LocalContextWithOwnConnection : HookedDbContext
        {
            ...
            /// </summary>
            /// <returns></returns>
            private static DbConnection GetWrappedConnection()
            {
                var connectionString = ConfigurationManager.ConnectionStrings["WrappedConnection"];
                return GetConnectionByConnectionString(connectionString.ConnectionString);
            }
            ...
            /// </summary>
            /// <param name="nameOrConnectionString">The name of the configured named connection string, or the connection string itself.</param>
            /// <returns></returns>
            ...
            {
                //Test whether it is a named connection
            ...
            public LocalContextWithOwnConnection()
                : base(GetWrappedConnection(), false)
            {
